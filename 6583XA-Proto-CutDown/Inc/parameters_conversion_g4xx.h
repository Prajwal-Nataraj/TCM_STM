...
#define ADV_TIM_CLK_MHz                  160 /* Actual TIM clk including Timer clock divider*/
#define ADC_CLK_MHz                      40
#define HALL_TIM_CLK                     160000000uL
#define APB1TIM_FREQ                     160000000uL
