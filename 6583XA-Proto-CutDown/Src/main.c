...
{
	if((LIM_SWU_Pin == GPIO_Pin) || (LIM_SWL_Pin == GPIO_Pin)) {
		Motor_CriticalStop();
	}
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LIM_SWL_Pin LIM_SWU_Pin */
  GPIO_InitStruct.Pin = LIM_SWL_Pin|LIM_SWU_Pin;
