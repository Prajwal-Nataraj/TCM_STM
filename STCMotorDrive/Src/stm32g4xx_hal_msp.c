...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA6     ------> ADC2_IN3
    */
    GPIO_InitStruct.Pin = M1_BUS_VOLTAGE_Pin|M1_OPAMP2_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PA6     ------> ADC2_IN3
    */
    HAL_GPIO_DeInit(GPIOA, M1_BUS_VOLTAGE_Pin|M1_OPAMP2_OUT_Pin);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA3     ------> OPAMP1_VINM
    */
    HAL_GPIO_DeInit(GPIOA, M1_CURR_SHUNT_U_Pin|M1_OPAMP1_OUT_Pin|M1_OPAMP1_EXT_GAIN_Pin);
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PB0     ------> OPAMP2_VINP_SEC
    */
    HAL_GPIO_DeInit(GPIOA, M1_OPAMP2_OUT_Pin|M1_CURR_SHUNT_V_Pin);

    HAL_GPIO_DeInit(M1_OPAMP2_EXT_GAIN_GPIO_Port, M1_OPAMP2_EXT_GAIN_Pin);
